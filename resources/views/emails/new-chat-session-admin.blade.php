...
<head>
    ...
    <title>New Chat Message - UCC-ERS</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <h1 class="greeting">New Chat Message</h1>
            <p class="message">
                <strong>{{ $chatUser->name }}</strong> has started a new chat conversation and is waiting for a response.
            </p>

            <div class="details-card">
                <div class="detail-row">
                    <span class="detail-label">Requester:</span>
                    <span class="detail-value">{{ $chatUser->name }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Email:</span>
                    <span class="detail-value">{{ $chatUser->email }}</span>
                </div>
                <div class="detail-row">
            ...
            <div style="text-align: center;">
                <a href="{{ route('admin.chat.index') }}" class="button">Reply in Messages</a>
            </div>
        </div>
